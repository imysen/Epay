...
<div class="ep-pay-card" style="width:min(420px,100%);text-align:center;padding:40px 24px 32px">
  ...
  <button class="ep-btn ep-btn-primary" id="Confirm" style="width:100%;height:44px">收款</button>
...
<div class="paypage-mask" id="loading" hidden><div class="paypage-loading"><span></span>正在加载…</div></div>
<div class="paypage-mask" id="dialog" hidden>
  <div class="paypage-dialog"><div id="dialog-content" style="font-size:14px;color:var(--ep-gray-700);line-height:1.6"></div><button class="ep-btn ep-btn-primary" id="dialog-close" style="width:100%;margin-top:20px">关闭</button></div>
</div>
<style>
...
confirmButton.addEventListener('click',async()=>{
  ...
  try{
    ...
    if(data.code==0)window.location.href=data.redirect_url;
